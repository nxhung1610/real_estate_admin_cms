...
class _$_RealEstateTypeResponse implements _RealEstateTypeResponse {
  _$_RealEstateTypeResponse({required this.id, required this.name});
  ...
  @override
  String toString() {
    return 'RealEstateTypeResponse(id: $id, name: $name)';
  }
...
abstract class _RealEstateTypeResponse implements RealEstateTypeResponse {
  factory _RealEstateTypeResponse(
      ...
      required final String name}) = _$_RealEstateTypeResponse;
