...
const StaffsResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'data', '3': 3, '4': 3, '5': 11, '6': '.pb.StaffInfo', '10': 'data'},
  ],
};

/// Descriptor for `StaffsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List staffsResponseDescriptor = $convert.base64Decode('Cg5TdGFmZnNSZXNwb25zZRIfCgtzdGF0dXNfY29kZRgBIAEoBVIKc3RhdHVzQ29kZRIYCgdtZXNzYWdlGAIgASgJUgdtZXNzYWdlEiEKBGRhdGEYAyADKAsyDS5wYi5TdGFmZkluZm9SBGRhdGE=');
...
const StaffResponse$json = const {
  ...
  '2': const [
    const {'1': 'status_code', '3': 1, '4': 1, '5': 5, '10': 'statusCode'},
    const {'1': 'message', '3': 2, '4': 1, '5': 9, '10': 'message'},
    const {'1': 'data', '3': 3, '4': 1, '5': 11, '6': '.pb.StaffInfo', '10': 'data'},
  ],
};

/// Descriptor for `StaffResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List staffResponseDescriptor = $convert.base64Decode('Cg1TdGFmZlJlc3BvbnNlEh8KC3N0YXR1c19jb2RlGAEgASgFUgpzdGF0dXNDb2RlEhgKB21lc3NhZ2UYAiABKAlSB21lc3NhZ2USIQoEZGF0YRgDIAEoCzINLnBiLlN0YWZmSW5mb1IEZGF0YQ==');
