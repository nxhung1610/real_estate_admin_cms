...
final $typed_data.Uint8List examineRealEstateRequestDescriptor =
    $convert.base64Decode(
        'ChhFeGFtaW5lUmVhbEVzdGF0ZVJlcXVlc3QSEwoFcmVfaWQYASABKAVSBHJlSWQ=');
...
final $typed_data.Uint8List rejectRealEstateRequestDescriptor =
    $convert.base64Decode(
        'ChdSZWplY3RSZWFsRXN0YXRlUmVxdWVzdBITCgVyZV9pZBgBIAEoBVIEcmVJZBIWCgZyZWFzb24YAiABKAlSBnJlYXNvbg==');
...
final $typed_data.Uint8List rejectTourRequestDescriptor = $convert.base64Decode(
    'ChFSZWplY3RUb3VyUmVxdWVzdBIXCgd0b3VyX2lkGAEgASgFUgZ0b3VySWQSFgoGcmVhc29uGAIgASgJUgZyZWFzb24=');
...
final $typed_data.Uint8List assignStaffForTourRequestDescriptor =
    $convert.base64Decode(
        'ChlBc3NpZ25TdGFmZkZvclRvdXJSZXF1ZXN0EhcKB3RvdXJfaWQYASABKAVSBnRvdXJJZBIZCghzdGFmZl9pZBgCIAEoBVIHc3RhZmZJZA==');
...
final $typed_data.Uint8List getStaffsRequestDescriptor = $convert.base64Decode(
    'ChBHZXRTdGFmZnNSZXF1ZXN0EhIKBHBhZ2UYASABKAVSBHBhZ2USFAoFbGltaXQYAiABKAVSBWxpbWl0');
...
final $typed_data.Uint8List getStaffByIdRequestDescriptor =
    $convert.base64Decode(
        'ChNHZXRTdGFmZkJ5SWRSZXF1ZXN0EhkKCHN0YWZmX2lkGAEgASgFUgdzdGFmZklk');
...
final $typed_data.Uint8List staffsResponseDescriptor = $convert.base64Decode(
    'Cg5TdGFmZnNSZXNwb25zZRIfCgtzdGF0dXNfY29kZRgBIAEoBVIKc3RhdHVzQ29kZRIYCgdtZXNzYWdlGAIgASgJUgdtZXNzYWdlEiEKBGRhdGEYAyADKAsyDS5wYi5TdGFmZkluZm9SBGRhdGE=');
...
final $typed_data.Uint8List staffResponseDescriptor = $convert.base64Decode(
    'Cg1TdGFmZlJlc3BvbnNlEh8KC3N0YXR1c19jb2RlGAEgASgFUgpzdGF0dXNDb2RlEhgKB21lc3NhZ2UYAiABKAlSB21lc3NhZ2USIQoEZGF0YRgDIAEoCzINLnBiLlN0YWZmSW5mb1IEZGF0YQ==');
