...
class AHistory extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AHistory', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'pb'), createEmptyInstance: create)
    ..aOM<AUser>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bidder', subBuilder: AUser.create)
  ...
  factory AHistory.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory AHistory.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  AHistory clone() => AHistory()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AHistory copyWith(void Function(AHistory) updates) => super.copyWith((message) => updates(message as AHistory)) as AHistory; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static AHistory create() => AHistory._();
  AHistory createEmptyInstance() => create();
  static $pb.PbList<AHistory> createRepeated() => $pb.PbList<AHistory>();
  @$core.pragma('dart2js:noInline')
  static AHistory getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AHistory>(create);
  static AHistory? _defaultInstance;

  @$pb.TagNumber(1)
  AUser get bidder => $_getN(0);
  @$pb.TagNumber(1)
  set bidder(AUser v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasBidder() => $_has(0);
  @$pb.TagNumber(1)
  void clearBidder() => clearField(1);
  @$pb.TagNumber(1)
  AUser ensureBidder() => $_ensure(0);
