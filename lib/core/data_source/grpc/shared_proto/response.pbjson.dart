...
@$core.Deprecated('Use aHistoryDescriptor instead')
const AHistory$json = const {
  '1': 'AHistory',
  '2': const [
    const {'1': 'bidder', '3': 1, '4': 1, '5': 11, '6': '.pb.AUser', '10': 'bidder'},
    const {'1': 'price', '3': 2, '4': 1, '5': 5, '10': 'price'},
    const {'1': 'created_at', '3': 3, '4': 1, '5': 9, '10': 'createdAt'},
  ],
};

/// Descriptor for `AHistory`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List aHistoryDescriptor = $convert.base64Decode('CghBSGlzdG9yeRIhCgZiaWRkZXIYASABKAsyCS5wYi5BVXNlclIGYmlkZGVyEhQKBXByaWNlGAIgASgFUgVwcmljZRIdCgpjcmVhdGVkX2F0GAMgASgJUgljcmVhdGVkQXQ=');
