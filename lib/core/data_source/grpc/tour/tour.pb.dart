...
class ListTourAdminRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListTourAdminRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'pb'), createEmptyInstance: create)
    ...
    ..a<$core.int>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'staffId', $pb.PbFieldType.O3)
    ...
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fromDate')
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'toDate')
    ..hasRequiredFields = false
  ;
  ...
  factory ListTourAdminRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ListTourAdminRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ListTourAdminRequest clone() => ListTourAdminRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListTourAdminRequest copyWith(void Function(ListTourAdminRequest) updates) => super.copyWith((message) => updates(message as ListTourAdminRequest)) as ListTourAdminRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ListTourAdminRequest create() => ListTourAdminRequest._();
  ListTourAdminRequest createEmptyInstance() => create();
  static $pb.PbList<ListTourAdminRequest> createRepeated() => $pb.PbList<ListTourAdminRequest>();
  @$core.pragma('dart2js:noInline')
  static ListTourAdminRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ListTourAdminRequest>(create);
  ...
  @$pb.TagNumber(5)
  set staffId($core.int v) { $_setSignedInt32(4, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(8)
  set fromDate($core.String v) { $_setString(7, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set toDate($core.String v) { $_setString(8, v); }
  @$pb.TagNumber(9)
...
class TourInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TourInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'pb'), createEmptyInstance: create)
    ...
    ..aOM<$1.AUser>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'staff', subBuilder: $1.AUser.create)
    ..a<$core.int>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.O3)
    ..aOM<$1.ARealEstate>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'realEstate', subBuilder: $1.ARealEstate.create)
    ..aOM<$1.AUser>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'user', subBuilder: $1.AUser.create)
  ...
  @$pb.TagNumber(5)
  set staff($1.AUser v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(7)
  set realEstate($1.ARealEstate v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set user($1.AUser v) { setField(8, v); }
  @$pb.TagNumber(8)
...
class ListTourResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListTourResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'pb'), createEmptyInstance: create)
    ...
    ..aOM<TourListRespData>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'data', subBuilder: TourListRespData.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set data(TourListRespData v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class TourListRespData extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TourListRespData', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'pb'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'total', $pb.PbFieldType.O3)
    ..pc<TourInfo>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'data', $pb.PbFieldType.PM, subBuilder: TourInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  factory TourListRespData.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory TourListRespData.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TourListRespData copyWith(void Function(TourListRespData) updates) => super.copyWith((message) => updates(message as TourListRespData)) as TourListRespData; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static TourListRespData create() => TourListRespData._();
  TourListRespData createEmptyInstance() => create();
  static $pb.PbList<TourListRespData> createRepeated() => $pb.PbList<TourListRespData>();
  @$core.pragma('dart2js:noInline')
  static TourListRespData getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TourListRespData>(create);
...
class TourAssignStaffForTourRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TourAssignStaffForTourRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'pb'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tourId', $pb.PbFieldType.O3)
    ..aOM<$1.AUser>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'staff', subBuilder: $1.AUser.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set staff($1.AUser v) { setField(2, v); }
  @$pb.TagNumber(2)
