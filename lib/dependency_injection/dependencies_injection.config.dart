...
import '../core/data_source/grpc/grpc_module.dart' as _i46;
import '../core/data_source/module/local_module.dart' as _i48;
import '../core/data_source/module/network_module.dart' as _i49;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i32.AdminServiceClient>(
    ...
    gh.factory<_i33.AuthBloc>(() => _i33.AuthBloc(gh<_i15.IAuthRepository>()));
    gh.factoryParam<_i34.AuthInterceptor, _i35.VoidCallback?, dynamic>((
      onExpireToken,
      _,
    ) =>
        _i34.AuthInterceptor(
    ...
    gh.factory<_i36.ConnectivityBloc>(
        () => _i36.ConnectivityBloc(gh<_i19.IConnectivityRepository>()));
    gh.lazySingleton<_i37.IAdminDataSource>(() => _i38.AdminDataSource(
        gh<_i10.IApiService>(instanceName: 'AuthApiService')));
    gh.lazySingleton<_i39.IAdminRepository>(() => _i40.AdminRepository(
          gh<_i32.AdminServiceClient>(instanceName: 'GRPC_ADMIN_SERVICE'),
          gh<_i25.ITourDataSource>(),
          gh<_i37.IAdminDataSource>(),
        ));
    gh.lazySingleton<_i41.ITourRepository>(() => _i42.TourRepository(
          gh<_i31.TourServiceClient>(instanceName: 'GRPC_TOUR_SERVICE'),
          gh<_i25.ITourDataSource>(),
        ));
    gh.factoryParam<_i43.RealEstateDetailBloc, String, dynamic>((
      id,
      _,
    ) =>
        _i43.RealEstateDetailBloc(
          id,
          gh<_i29.RealEstateRepository>(),
        ));
    gh.factory<_i44.StaffSelectedCubit>(
        () => _i44.StaffSelectedCubit(gh<_i39.IAdminRepository>()));
    gh.factory<_i45.ApprovalBloc>(() => _i45.ApprovalBloc(
          gh<_i41.ITourRepository>(),
          gh<_i39.IAdminRepository>(),
          gh<_i29.RealEstateRepository>(),
        ));
    return this;
  }
...
class _$GrpcModule extends _i46.GrpcModule {}

class _$ThirtModule extends _i47.ThirtModule {}

class _$LocalModule extends _i48.LocalModule {}
